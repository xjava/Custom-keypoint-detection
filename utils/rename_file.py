...
def rename_files_in_directory(directory_path, start_sequence=1, pattern="file{seq}.txt", num_digits=1):
...
def main():
    ...
    parser.add_argument('--directory_path', type=str, default="/Users/nikornlansa/Downloads/image_v2/doc/test5",
    ...
    parser.add_argument('--pattern', type=str, default="IMG_01_01-{seq}.JPG",
