...
def convert_mendeley_cvs_to_csv_files(input_dir, output_dir, max_size, scale_down_only):
    ...
    for jpg_file in jpg_files:
        ...
        with open(input_csv_path, mode='r', newline='', encoding='utf-8') as f:
            ...
            new_row = [top_left_x, top_left_y, top_right_x, top_right_y, bottom_right_x, bottom_right_y, bottom_left_x, bottom_left_y]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir', type=str, default='/Users/nikornlansa/Downloads/csv_datasets', help='Path to the input directory')
    parser.add_argument('--output_dir', type=str, default='/Users/nikornlansa/Downloads/temp_csv_datasets', help='Path to the output directory')
    ...
    convert_mendeley_cvs_to_csv_files(args.input_dir, args.output_dir, args.max_size, args.scale_down_only)
